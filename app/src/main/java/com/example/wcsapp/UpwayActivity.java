...
public class UpwayActivity extends AppCompatActivity {
    ...
    private ImageView imageViewbjnumber;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0x001:
                   ...
                   CustomToast.showToast(UpwayActivity.this, json.getString("msg"), 1500);
                    goodshow.setText("");
                    localid.setText("");
                    UpWaynumber.setText("");
                    UpWaynumber.setFocusable(false);
                    ...
                    case 0x002:
                        ...
                        break;
                case 0x003:
                    imageViewbjnumber.setVisibility(View.VISIBLE);
                    PutWaynumbertext.setVisibility(View.VISIBLE);
                    UpWaynumber.setVisibility(View.VISIBLE);
                    UpWaynumber.setFocusableInTouchMode(true);
                    Apply.setEnabled(true);
                    Apply.setTextColor(getResources().getColor(R.color.colorblack) );
                    break;
                case 0x005:
                    CustomToast.showToast(UpwayActivity.this, "服务器加载错误", 1500);
                    break;
                case 0x006:
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upway);
        ...
        UpWaynumber.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                UpWaynumber.setEnabled(true);
            }
        });
              ...
              int i =  NetWorkUtils.getAPNType(getApplicationContext());
                if (i!=0){
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            try {
                                sendByOKHttpio(NetWorkPost.URLInfos.PUTOFFSHELVES,surelightdata());
    ...
    public  String surelightdata(){
       // String l = "{\"sku\":\""+goodshow.getText().toString()+"\",\"tolocation\":\""+localid.getText().toString()+"\"}";
        JsonObject js=new JsonObject();
        js.addProperty("sku",goodshow.getText().toString());
        js.addProperty("tolocation",localid.getText().toString());
        MyLOg.d("upwaypostjson",String.valueOf(js));
    ...
    private void displayScanResult(Intent initiatingIntent, String howDataReceived)
    {
        ...
        if (!goodshow.getText().toString().isEmpty()&&!localid.getText().toString().isEmpty())
            CustomToast.showToast(this,"请清空再扫描！",1500);
        if (goodshow.getText().toString().isEmpty()){
            goodshow.setText(decodedData);
            handler.sendEmptyMessage(0x002);
       }else if (localid.getText().toString().isEmpty()){
    ...
    private void CreateProfile (String profileName, String code128Value, String ean13Value){
        ...
        {
            activityName = UpwayActivity.class.getSimpleName();
        }
